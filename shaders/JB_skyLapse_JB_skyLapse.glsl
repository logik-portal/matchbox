...
// You can't modify uniforms like this, not sure why
// they were uniforms to begin with or how it ever worked :)
// Moved resolution to a global (see way above) as it's used
...
float time = adsk_time * timeSpeed;
